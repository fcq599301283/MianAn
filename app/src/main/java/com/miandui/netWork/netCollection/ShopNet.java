...
public class ShopNet {
    public static void getGoods(Map<String, String> map, DefaultCallback callback) {
        BaseRequest.DefautPostRequest(BaseUrl.GET_GOODS, map, callback);
    }

    public static void getShops(DefaultCallback callback) {
        BaseRequest.DefautPostRequest(BaseUrl.GET_SHOPS, new HashMap<String, String>(), callback);
    }

    public static void getValidTickets(Map<String, String> map, DefaultCallback callback) {
        BaseRequest.DefautPostRequest(BaseUrl.GET_MY_TICKETS, map, callback);
    }

    public static void getInvalidTickets(Map<String, String> map, DefaultCallback callback) {
        BaseRequest.DefautPostRequest(BaseUrl.GET_TICKET_RECORD, map, callback);
    }
