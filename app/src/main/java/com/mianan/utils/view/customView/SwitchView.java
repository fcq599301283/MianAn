package com.mianan.utils.view.customView;
...
//		paint.setColor(isOn ? 0xff4bd763 : 0xffe3e3e3);
        paint.setColor(isOn ? getResources().getColor(R.color.yeff) : 0xffe3e3e3);
...
//        paint.setColor(isOn ? 0xff4ada60 : 0xffbfbfbf);
        paint.setColor(isOn ? getResources().getColor(R.color.yeff) : 0xffbfbfbf);
        canvas.drawPath(bPath, paint);
